 ...
 * <p>
 * This class bridges our application's User entity with Spring Security's UserDetails interface,
 * enabling authentication providers to look up and verify users during the login process.
 * </p>
 */
@Service

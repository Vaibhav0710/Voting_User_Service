...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // Skip filtering if there's no Authorization header or if it doesn't start with "Bearer "
        ...
        try {
            ...
            // Ignore token extraction/validation failures to let the request continue as unauthenticated
            // (the SecurityFilterChain will block it if the endpoint requires authentication)
        }
